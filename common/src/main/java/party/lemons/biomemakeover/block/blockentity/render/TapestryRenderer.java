...
public class TapestryRenderer implements BlockEntityRenderer<TapestryBlockEntity>
{
    ...
    public TapestryRenderer(BlockEntityRendererProvider.Context context)
    {
    ...
    @Override
    public void render(TapestryBlockEntity tapestry, float f, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j) {
        long time;
        float scale = 0.66f;
        ...
        else
        {
            ...
            float rotation;
            if (!(blockState.getBlock() instanceof AbstractTapestryWallBlock))
            {
                poseStack.translate(0.5, 0.5, 0.5);
    ...
    public static void renderTapestry(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j, ModelPart modelPart, TapestryBlockEntity tapestry)
    {
        ResourceLocation location = ((AbstractTapestryBlock)tapestry.getBlockState().getBlock()).getRenderTexture();
