...
public enum QuestRewardTable
{
    ...
    private static List<RewardItem> createItemTable()
    {
        return Lists.newArrayList(
                ...
                new ItemStackRewardItem(new ItemStack(BMItems.SWAMP_JIVES_MUSIC_DISK.get()), 1, 1),
                new ItemStackRewardItem(new ItemStack(Blocks.PEARLESCENT_FROGLIGHT), 5, 15),
                new ItemStackRewardItem(new ItemStack(Blocks.OCHRE_FROGLIGHT), 5, 15),
                new ItemStackRewardItem(new ItemStack(Blocks.VERDANT_FROGLIGHT), 5, 15)
        );
    }
    ...
    private static List<RewardItem> createPotionIngredientTable()
    {
        return Lists.newArrayList(
                ...
                new ItemStackRewardItem(new ItemStack(BMItems.SOUL_EMBERS.get()), 3, 5),
    ...
    private static List<RewardItem> createPotionTable()
    {
        return Lists.newArrayList(
                ...
                new PotionRewardItem(BMPotions.ANTIDOTE_POT.get()),
                new ItemStackRewardItem(new ItemStack(BMItems.SWAMP_JIVES_MUSIC_DISK.get()), 1, 1)
        );
    }
    ...
    {
        return Lists.newArrayList(
                new PotionRewardItem(BMPotions.ADRENALINE.get()),
                new PotionRewardItem(BMPotions.ASSASSIN.get()),
                new PotionRewardItem(BMPotions.DARKNESS.get()),
                new PotionRewardItem(BMPotions.DOLPHIN_MASTER.get()),
                new PotionRewardItem(BMPotions.LIQUID_BREAD.get()),
                new PotionRewardItem(BMPotions.PHANTOM_SPIRIT.get()),
                new PotionRewardItem(BMPotions.LIGHT_FOOTED.get()),
                new PotionRewardItem(BMPotions.MINER.get())
        );
    }
