...
public class DecayedRender extends AbstractZombieRenderer<DecayedEntity, DecayedModel>
{
    ...
    private static class DecayedItemInHandLayer extends ItemInHandLayer<DecayedEntity, DecayedModel> {
        ...
        @Override
        protected void renderArmWithItem(LivingEntity livingEntity, ItemStack itemStack, ItemDisplayContext transformType, HumanoidArm humanoidArm, PoseStack poseStack, MultiBufferSource multiBufferSource, int i) {
