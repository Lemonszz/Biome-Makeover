...
public class BMBlocks
{
    ...
    public static Supplier<Block> registerLilyPad(String id, Supplier<Block> block)
    {
        ...
        ITEMS.register(BiomeMakeover.ID(id), ()->new PlaceOnWaterBlockItem(bl.get(), new Item.Properties().tab(BiomeMakeover.TAB)));
    ...
    public static final TagKey<Block> FARMLAND = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation("c", "farmland"));
}
