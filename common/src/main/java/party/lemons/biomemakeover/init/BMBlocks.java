...
public class BMBlocks
{
    ...
    public static final BMBlock PEAT = new BMBlock(properties(Material.DIRT, 0.5F).sound(SoundType.WET_GRASS)).modifiers(new HoeModifier(()->BMBlocks.PEAT_FARMLAND));
    public static final BMBlock DRIED_PEAT = new BMBlock(properties(Material.DIRT, 1F).sound(SoundType.NETHERRACK));
    public static final BMBlock MOSSY_PEAT = new BMSpreadableBlock(properties(Material.DIRT, 0.5F).randomTicks().sound(SoundType.WET_GRASS), ()->PEAT).modifiers(new HoeModifier(()->BMBlocks.PEAT_FARMLAND));
    ...
    public static final BMTallFlowerBlock BLACK_THISTLE = new BlackThistleBlock(properties(Material.PLANT, 0).noCollission().instabreak().sound(SoundType.GRASS)).modifiers(RTypeModifier.create(RType.CUTOUT), CompostModifier.create(0.65F), FlammableModifier.TALL_FLOWER);
