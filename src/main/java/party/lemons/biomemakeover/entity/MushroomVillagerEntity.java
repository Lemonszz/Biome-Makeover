...
public class MushroomVillagerEntity extends MerchantEntity
{
	...
	public static final Int2ObjectMap<TradeOffers.Factory[]> TRADES = new Int2ObjectOpenHashMap(ImmutableMap.of(1, new TradeOffers.Factory[]{new TradeOffers.SellItemFactory(Items.BROWN_MUSHROOM, 1, 3, 12, 1), new TradeOffers.SellItemFactory(Items.RED_MUSHROOM, 1, 3, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.PURPLE_GLOWSHROOM, 2, 3, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.ORANGE_GLOWSHROOM, 2, 3, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.GREEN_GLOWSHROOM, 2, 3, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.GREEN_GLOWSHROOM_BLOCK, 2, 2, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.ORANGE_GLOWSHROOM_BLOCK, 2, 2, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.PURPLE_GLOWSHROOM_BLOCK, 2, 2, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.TALL_BROWN_MUSHROOM, 1, 2, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.TALL_RED_MUSHROOM, 1, 2, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.GLOWSHROOM_STEM, 2, 2, 12, 1), new TradeOffers.SellItemFactory(Blocks.MUSHROOM_STEM, 1, 2, 12, 1), new TradeOffers.SellItemFactory(Blocks.RED_MUSHROOM_BLOCK, 1, 2, 12, 1), new TradeOffers.SellItemFactory(Blocks.BROWN_MUSHROOM_BLOCK, 1, 2, 12, 1), new TradeOffers.SellItemFactory(BMBlocks.MYCELIUM_ROOTS, 1, 4, 12, 1)}, 2, new TradeOffers.Factory[]{new TradeOffers.SellItemFactory(BMItems.BUTTON_MUSHROOMS_MUSIC_DISK, 8, 1, 4, 1), new TradeOffers.SellItemFactory(BMItems.GLOWSHROOM_STEW, 1, 1, 4, 1)}));
