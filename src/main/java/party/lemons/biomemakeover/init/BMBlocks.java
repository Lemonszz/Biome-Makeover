...
public class BMBlocks
{
    ...
    public static final DeepMyceliumBlock DEEP_MYCELIUM = new DeepMyceliumBlock(settings(Material.ORGANIC_PRODUCT, 0.6F).lightLevel(3).ticksRandomly().sounds(BlockSoundGroup.GRASS));
