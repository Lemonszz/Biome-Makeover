...
public class BMEntities
{
	...
	public static final EntityType<OwlEntity> OWL = FabricEntityTypeBuilder.<OwlEntity>create(SpawnGroup.CREATURE, (t, w)->new OwlEntity(w)).dimensions(EntityDimensions.fixed(0.7F, 0.8F)).trackRangeBlocks(12).build();
