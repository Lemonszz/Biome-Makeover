...
public class BMEntities
{
	...
	public static final EntityType<TadpoleEntity> TADPOLE = FabricEntityTypeBuilder.<TadpoleEntity>create(SpawnGroup.WATER_CREATURE, (t, w)->new TadpoleEntity(w)).dimensions(EntityDimensions.fixed(0.8F, 0.6F)).trackRangeBlocks(12).build();
