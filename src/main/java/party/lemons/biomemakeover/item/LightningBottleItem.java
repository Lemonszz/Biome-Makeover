...
public class LightningBottleItem extends Item
{
	public LightningBottleItem(Settings settings)
	{
		...
		DispenserBlock.registerBehavior(this, (pointer, stack)->(new ProjectileDispenserBehavior()
		{
	...
	public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand)
	{
		...
		world.playSound(null, user.getX(), user.getY(), user.getZ(), BMEffects.LIGHTNING_BOTTLE_THROW, SoundCategory.NEUTRAL, 0.5F, 0.4F / (RANDOM.nextFloat() * 0.4F + 0.8F));
