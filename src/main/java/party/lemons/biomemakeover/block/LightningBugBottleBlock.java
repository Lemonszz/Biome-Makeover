...
public class LightningBugBottleBlock extends BMBlock implements BlockEntityProvider, Waterloggable
{
	...
	private static final VoxelShape LOWER_SHAPE = VoxelShapes.union(Block.createCuboidShape(4.0D, 0.0D, 4.0D, 12.0D, 8.0D, 12.0D), Block.createCuboidShape(6.0D, 8.0D, 6.0D, 10.0D, 12.0D, 10.0D));
	private static final VoxelShape UPPER_SHAPE = VoxelShapes.union(Block.createCuboidShape(4.0D, 4.0D, 4.0D, 12.0D, 12.0D, 12.0D), Block.createCuboidShape(6.0D, 11.0D, 6.0D, 10.0D, 16.0D, 10.0D));
